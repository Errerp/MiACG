...
if(EXISTS "D:/labexample/external-libs/SDL2-2.26.5.tar.gz")
  check_file_hash(has_hash hash_is_good)
  if(has_hash)
    if(hash_is_good)
      message(STATUS "File already exists and hash match (skip download):
  file='D:/labexample/external-libs/SDL2-2.26.5.tar.gz'
  MD5='47f22c109070431ecccd90abd3c0ab6e'"
      )
      return()
    else()
      message(STATUS "File already exists but hash mismatch. Removing...")
      file(REMOVE "D:/labexample/external-libs/SDL2-2.26.5.tar.gz")
    endif()
  else()
...
message(STATUS "Downloading...
   dst='D:/labexample/external-libs/SDL2-2.26.5.tar.gz'
   timeout='none'
...
foreach(i RANGE ${retry_number})
  ...
  foreach(url IN ITEMS [====[http://www.libsdl.org/release/SDL2-2.26.5.tar.gz]====])
    if(NOT url IN_LIST skip_url_list)
      ...
      file(
        DOWNLOAD
        "${url}" "D:/labexample/external-libs/SDL2-2.26.5.tar.gz"
        SHOW_PROGRESS
        # no TIMEOUT
